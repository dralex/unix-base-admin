...
<xsl:stylesheet  	
  ...
  <xsl:template match="presentation">
	...
	<a>
	  <xsl:attribute name="href">
	    <xsl:text>#pres</xsl:text><xsl:value-of select="@number"/>
	  </xsl:attribute>
	  <xsl:attribute name="class">
            <xsl:text>presentation</xsl:text>
	  </xsl:attribute>
  ...
  <xsl:template match="small-presentation">
	...
	<p><a>
	  <xsl:attribute name="href">
	    <xsl:text>pres/lect</xsl:text><xsl:value-of select="@number"/><xsl:text>.png</xsl:text>
	  </xsl:attribute>
	  <img>
	    <xsl:attribute name="src">
	      <xsl:text>pres/small-lect</xsl:text><xsl:value-of select="@number"/><xsl:text>.png</xsl:text>
	    </xsl:attribute>
